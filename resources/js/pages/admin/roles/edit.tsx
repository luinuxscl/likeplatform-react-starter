...
export default function AdminRolesEdit({ role, permissions }: { role: RolePayload; permissions: string[] }) {
    const { t } = useI18n()
    ...
    const breadcrumbs: BreadcrumbItem[] = useMemo(() => [
        ...
        { title: t('Editar'), href: `/admin/roles/${role.id}/edit` },
    ], [t, role.id])
